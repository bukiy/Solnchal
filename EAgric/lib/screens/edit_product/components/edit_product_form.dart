...
import 'package:EAgric/components/default_button.dart';
import 'package:EAgric/exceptions/local_files_handling/image_picking_exceptions.dart';
import 'package:EAgric/exceptions/local_files_handling/local_file_handling_exception.dart';
import 'package:EAgric/models/Product.dart';
import 'package:EAgric/screens/edit_product/provider_models/ProductDetails.dart';
import 'package:EAgric/services/database/product_database_helper.dart';
import 'package:EAgric/services/firestore_files_access/firestore_files_access_service.dart';
import 'package:EAgric/services/local_files_access/local_files_access_service.dart';
...
class _EditProductFormState extends State<EditProductForm> {
  ...
  Widget buildHighlightsField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText:
            "e.g., After-sales Service Provided: Free spare parts, No overseas service provided || Warranty: 2 years, 2 Years || Applicable Industries:",
  ...
  Widget buildDescriptionField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText:
            "e.g.,  120HP Four Wheel Farm Tractor In Georgia.",
  ...
  Widget buildSellerField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.name,
      decoration: InputDecoration(
        hintText: "e.g., Huabo Agricultural Equipment Co., Ltd.",
        labelText: "Seller",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (_) {
  ...
  Widget buildOriginalPriceField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: "e.g., 11999.0",
        labelText: "Original Price (in USD)",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (_) {
  ...
  Widget buildDiscountPriceField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.number,
      decoration: InputDecoration(
        hintText: "e.g., 10999.0",
        labelText: "Discount Price (in USD)",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (_) {
