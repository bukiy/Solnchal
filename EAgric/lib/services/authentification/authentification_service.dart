...
import 'package:EAgric/exceptions/firebaseauth/messeged_firebaseauth_exception.dart';
import 'package:EAgric/exceptions/firebaseauth/credential_actions_exceptions.dart';
import 'package:EAgric/exceptions/firebaseauth/reauth_exceptions.dart';
import 'package:EAgric/exceptions/firebaseauth/signin_exceptions.dart';
import 'package:EAgric/exceptions/firebaseauth/signup_exceptions.dart';
...
class AuthentificationService {
  ...
  Future<bool> signUp({String email, String password, String name}) async {
    try {
      ...
      await UserDatabaseHelper().createNewUser(userCredential.user, uid, name, email);
      return true;
    } on MessagedFirebaseAuthException {
      rethrow;
    } on FirebaseAuthException catch (e) {
  ...
  Future<void> updateCurrentUserDisplayName(String updatedDisplayName) async {
    ...
    await firestore.collection(USERS_COLLECTION_NAME).doc(currentUser.uid).update({
