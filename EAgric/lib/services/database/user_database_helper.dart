...
import 'package:EAgric/models/CartItem.dart';
import 'package:EAgric/models/OrderedProduct.dart';
...
class UserDatabaseHelper {
  static const String USERS_COLLECTION_NAME = "Farmer";
  ...
  static const String CREATED_KEY = 'created_at';
  static const String lastMessageTime_KEY = 'lastMessageTime';
  ...
  Future<void> createNewUser(User user,String uid, String name, String email) async {
    await firestore.collection(USERS_COLLECTION_NAME).doc(uid).set({
      NAME_KEY: name,
      EMAIL_KEY: email,
      ROLE_KEY: "Farmer",
      UID_KEY: uid,
      CREATED_KEY: user.metadata.lastSignInTime,
      DP_KEY: null,
      PHONE_KEY: null,
      FAV_PRODUCTS_KEY: List<String>(),
      // lastMessageTime_KEY: null,
    });
  }

  Future<void> chat(String message, String uid) async {
    await firestore.collection("message").doc(uid).set({
      message_KEY: message,
      UID_KEY: uid,
    });
  }
